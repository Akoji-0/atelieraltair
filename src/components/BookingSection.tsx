                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {availableSlots.map((time) => (
                        <Button
                          ...
                          className={`p-3 font-light tracking-wide transition-colors duration-300 ${
                            selectedTime === time
                    ...
                    {selectedTime && (
                      <div className="pt-6 border-t border-white/10">
                        <Button
                          ...
                          className="w-full bg-white text-black hover:bg-gray-200 py-3 font-light tracking-wide transition-colors duration-300"
                        >
                          Réserver ce créneau
                        </Button>
                      </div>
