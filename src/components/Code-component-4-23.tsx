      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button
            ...
            className="bg-white text-black hover:bg-white/90 px-8 py-3 text-lg font-light tracking-wide transition-all duration-300"
          >
            Voir mes créations
          </Button>
          <Button
            ...
            variant="outline"
            className="border-white text-white hover:bg-white hover:text-black px-8 py-3 text-lg font-light tracking-wide transition-all duration-300"
          >
            Prendre rendez-vous
          </Button>
        </div>
